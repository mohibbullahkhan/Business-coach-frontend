  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        ...
        action={<button className="flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 text-sm font-medium"><Plus className="w-4 h-4"/> Add Testimonial</button>}
      />
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {mockTestimonials.map(test => (
          <div key={test.id} className={`bg-white p-6 rounded-xl border ${test.visible ? 'border-gray-200' : 'border-gray-200 bg-gray-50/50 opacity-70'} shadow-sm relative`}>
            ...
            <div className="mt-6 pt-4 border-t border-gray-100 flex items-center justify-between">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" className="sr-only peer" checked={test.visible} readOnly />
